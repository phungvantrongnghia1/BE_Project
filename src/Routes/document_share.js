...
const { share_document, get_docs_share, re_share, dele_user_shared, delete_docs_share, update, search_document_share, get_docs_public } = require("../Controllers/document_share");
...
router.get('/get_docs_public', get_docs_public); //Get detail document
